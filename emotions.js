        ...
        const styles = `
            <style>
                .em-container { 
                    ...
                    touch-action: pan-y; /* Фиксация: только вертикальный скролл */
                } 
                ...
                /* Стили модального окна (формы ввода) */
                .em-modal {
                    position: fixed; top: 0; left: 0; width: 100%; height: 100%;
                    background: rgba(0,0,0,0.4); z-index: 2000; display: flex; align-items: flex-end;
                    touch-action: none; /* Блокируем фон при открытой форме */
                }
                .em-modal-content {
