const GoodDayModule = {
    config: {
        ...
        placeholder: 'Какое приятное событие произошло сегодня?'
    },
    data: [],
    editingId: null,
    ...
    render: function() {
        ...
        app.innerHTML = styles + `
            <div class="ls-wrap">
                ...
                <div class="ls-list">${listHtml || '<div style="text-align:center; color:#8E8E93; margin-top:40px;">День был обычным? Вспомните хоть мелочь!</div>'}</div>
            </div>
